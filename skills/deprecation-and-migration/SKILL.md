...
- `../api-and-interface-design/SKILL.md` — when the replacement involves new public interfaces
- `../word-document/SKILL.md` — when the deliverable is a migration plan or deprecation notice in DOCX
- `../_shared/architecture-document-principles.md` — migration plan sections and ADR lifecycle
