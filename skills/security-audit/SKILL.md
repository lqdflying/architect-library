...
1. **Recon** — Run Phase 1 from [references/RECONNAISSANCE.md](references/RECONNAISSANCE.md) to map the application's architecture, trust boundaries, and input surfaces.
2. **Hunt** — Use [references/HUNTING.md](references/HUNTING.md) for Phase 2 orchestration, methodology, and validation rules; select scopes from [references/ATTACK-CLASSES.md](references/ATTACK-CLASSES.md).
3. **Validate** — Use Phase 3 in [references/VALIDATION-AND-REPORTING.md](references/VALIDATION-AND-REPORTING.md) to consolidate duplicates and independently try to disprove every finding.
4. **Report** — Use Phase 4 in [references/VALIDATION-AND-REPORTING.md](references/VALIDATION-AND-REPORTING.md) to write `REPORT.md` and `FINDINGS-DETAIL.md`.
5. **Structured output** — Use Phase 5 in [references/VALIDATION-AND-REPORTING.md](references/VALIDATION-AND-REPORTING.md), `references/report-schema.json`, and `references/validate-findings.cjs` to write and validate `findings.json`.
6. **Independent verification** — Use Phase 6 in [references/VALIDATION-AND-REPORTING.md](references/VALIDATION-AND-REPORTING.md) to verify every factual claim and reconcile all outputs.
